...
function BloodGlucoseStop(props){
  return (
    <>
      <div className="bg-stop-container">
        <div className="bg-stop-container1">
          <div className="bg-stop-html-node">
            <span
          ...
          <span className="bg-stop-text4">Diagnosing blood sample...</span>
        </div>
      </div>
      <style jsx>
...
//   sp02_reading11: PropTypes.string,
// }

export default BloodGlucoseStop

  ...
  return (
    <>
      <div className="login3-container">
        <div className="login3-container1">
          ...
          <span className="login3-text1">Name</span>
          <span className="login3-text2">    </span>
          ...
          <div className="login3-html-node">
            <span
          ...
          <div className="login3-html-node1">
            <span
              dangerouslySetInnerHTML={{
                __html:
          ...
          <div className="login3-html-node2">
            <span
              dangerouslySetInnerHTML={{
                __html:
